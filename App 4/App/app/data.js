/* ============================================================
   ...
   ============================================================ */
window.GMUtils = {
  relativeDate: function(daysOffset) {
    const d = new Date();
    d.setDate(d.getDate() + daysOffset);
    return d;
  },
  formatDayMonth: function(daysOffset) {
    const d = new Date();
    d.setDate(d.getDate() + daysOffset);
    const months = ['ene', 'feb', 'mar', 'abr', 'may', 'jun', 'jul', 'ago', 'sep', 'oct', 'nov', 'dic'];
    return `${d.getDate()} ${months[d.getMonth()]}`;
  },
  formatDayMonthYear: function(daysOffset) {
    const d = new Date();
    d.setDate(d.getDate() + daysOffset);
    const months = ['ene', 'feb', 'mar', 'abr', 'may', 'jun', 'jul', 'ago', 'sep', 'oct', 'nov', 'dic'];
  ...
  getTodayStr: function() {
    ...
    return `Hoy, ${d.getDate()} de ${months[d.getMonth()]}`;
  }
};
...
window.GM = (function () {
  ...
  const alerts = [
    ...
    { id:"a3", type:"retraso", title:"Paso sin actividad",
      body:"«Manuales» lleva 8 días bloqueado esperando el KV de campaña de Marketing.", step:"Manuales", screen:"manuales", age:"8 d" },
  ...
  // ---- Aprobaciones por paso (Compradores) ----
  // status: 'sin_acceso' | 'en_revision' | 'cambios' | 'rechazado' | 'aprobado'
  // Prototipo: todos los pasos son accesibles para compradores desde el inicio
  const stepApprovals = {
    tendencias:       { status: "aprobado",    sentAt: "10 jun", resolvedAt: "11 jun",
      comments: [
        { author: "VG", role: "valentina",   text: "Informe de tendencias PV26 completo. Paleta y prendas prioritarias definidas con base en análisis WGSN y ventas internas.", date: "10 jun · 09:14" },
        { author: "CP", role: "compradores", text: "Conforme con el análisis. La paleta de temporada está alineada con las proyecciones de venta. Moodboard aprobado.", date: "11 jun · 11:32" },
      ] },
    viaje:            { status: "cambios",     sentAt: "12 jun", resolvedAt: null,
      comments: [
        { author: "VG", role: "valentina",   text: "Registro de compras completo. Todos los ítems críticos encontrados, salvo punto seamless — se busca alternativa local.", date: "12 jun · 15:40" },
        { author: "CP", role: "compradores", text: "Aprobado el viaje, pero necesitamos resolver el punto seamless antes de avanzar a colección. Por favor confirma proveedor alternativo.", date: "12 jun · 17:05" },
      ] },
    coleccion:        { status: "en_revision", sentAt: "13 jun", resolvedAt: null,
      comments: [
        { author: "VG", role: "valentina", text: "Propuesta de colección enviada. 42 SKUs distribuidos en 3 ventanas. Paleta alineada con el moodboard aprobado.", date: "13 jun · 10:20" },
      ] },
    muestras:         { status: "en_revision", sentAt: "14 jun", resolvedAt: null,
      comments: [
        { author: "VG", role: "valentina", text: "18 de 24 muestras recibidas. Pendientes: 2 prendas de Proveedor Textil Andina y 4 de Ningbo Garments.", date: "14 jun · 09:00" },
      ] },
    fichas:           { status: "en_revision", sentAt: "14 jun", resolvedAt: null,
      comments: [
        { author: "VG", role: "valentina", text: "15 fichas completas enviadas para revisión comercial. Las 9 restantes están en progreso, entrega estimada en 3 días.", date: "14 jun · 14:30" },
      ] },
    contramuestras:   { status: "en_revision", sentAt: "20 jun", resolvedAt: null, comments: [
        { author: "VG", role: "valentina", text: "Contramuestras recibidas de 3 proveedores. 8 de 24 conformes. Detalle adjunto.", date: "20 jun · 11:00" },
      ] },
    manuales:         { status: "en_revision", sentAt: "22 jun", resolvedAt: null, comments: [] },
    negociacion:      { status: "en_revision", sentAt: "25 jun", resolvedAt: null, comments: [
        { author: "VG", role: "valentina", text: "Negociación cerrada con 4 de 5 proveedores. Precio promedio negociado: $16.800 CLP (ahorro 11,5% vs. precio inicial).", date: "25 jun · 16:00" },
      ] },
    fichas_revisadas: { status: "en_revision", sentAt: "28 jun", resolvedAt: null, comments: [] },
    validacion:       { status: "en_revision", sentAt: "30 jun", resolvedAt: null, comments: [] },
  };

  return { season, steps, ball, alerts, metrics, providers, palettes, skus, emailThreads, trends, cat, win, validationStages, stepApprovals };
})();
